...
export default function PostTrending() {
  return (
            ...
            <div className="trending-post">
              ...
              <div className="single-post-wrap style-overlay">
                ...
                <div className="details">
                  ...
                  <h6 className="title">
                    <a href="#">Flight schedule and quarantine</a>
                  </h6>
                </div>
              </div>
              <div className="single-post-wrap style-overlay">
                ...
                <div className="details">
                  ...
                  <h6 className="title">
                    <a href="#">Indore bags cleanest city</a>
                  </h6>
                </div>
              </div>
            </div>
              ...
              <div className="media">
                ...
                <div className="media-body">
                  <div className="details">
                    ...
                    <h6 className="title">
                      <a href="#">
                        The FAA will drone detect-ing in airports this year
                      </a>
                    </h6>
                  </div>
                </div>
          ...
          <div className="item">
            <div className="single-post-wrap">
              ...
              <div className="details">
                ...
                <h6 className="title">
                  <a href="#">
                    Uttarakhand’s Hemkund Sahib yatra to start from September 4
                  </a>
                </h6>
                <p>
